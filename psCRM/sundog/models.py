...
from utils import document_directory_path
import logging
import constants
...
#
#
# class CommunityOfInterest(models.Model):
#     community_id = models.AutoField(primary_key=True)
#     name = models.CharField(max_length=100, unique=True)
#     area = models.ForeignKey(AreaOfInterest)
#
#     def __unicode__(self):
#         return '%s' % self.name
#
#     class Meta:
#         verbose_name = 'Community of Interest'
#         verbose_name_plural = 'Communities of Interest'
...
class FileStatusHistory(models.Model):
    ...
    def create_new_file_status_history(self, previous_status, current_status, user):
...
class MyFile(models.Model):
    ...
    invoice_price = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
