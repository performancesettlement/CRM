...
class ServiceTestCase(unittest.TestCase):
    ...
    @mock.patch("sundog.services.ContentType")
    @mock.patch("sundog.services.Permission")
    def test_upload_import_file_success(self, mock_permission, mock_content_type, mock_file_status_history, mock_check_tag_exists, mock_check_username_exists, mock_xldate_as_tuple, mock_my_file_class, mock_save_import_history, mock_client_exists, mock_default_status, mock_status_exists, mock_open_workbook):
        mock_content_type.objects.get.return_value = ContentType(
            app_label="app_label", model="ContentType")
        mock_permission.objects.create.return_value = None
        ...
        mock_xldate_as_tuple.return_value = (2015, 0o1, 25, 0, 0, 0)
